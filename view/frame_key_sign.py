...
from constant import (
    LABEL_PUBKEY_SIGN_INIT,
    LABEL_SECKEY_SIGN_INIT,
    SIGN_KEYLENGHT_DICT,
    BTN_SHOW_KEY,
    BTN_OPEN_KEY,
    BTN_SAVE_KEY,
    BTN_GENERATE_KEY,
    LABEL_PUBKEY_SIGN_NEEDSAVE,
    LABEL_SECKEY_SIGN_NEEDSAVE,
    KEYS_DIR,
    TITLE_ERROR_MESSAGE,
)
...
class FrameKeySign:
    def __init__(self, master):
        self.cipher = SignCipher()

        self.pubkey = StringVar()
        self.seckey = StringVar()
        self.pubkey_fname = StringVar(value=LABEL_PUBKEY_SIGN_INIT)
        self.seckey_fname = StringVar(value=LABEL_SECKEY_SIGN_INIT)
    ...
    def frame_draw(self, master):
        ...
        combo = ttk.Combobox(
            master,
            width=10,
            values=list(SIGN_KEYLENGHT_DICT.keys()),
    ...
    def key_generate(self, *args):
        block_size = SIGN_KEYLENGHT_DICT[self.keylenght.get()]
        ...
        self.pubkey_fname.set(LABEL_PUBKEY_SIGN_NEEDSAVE)
        self.seckey_fname.set(LABEL_SECKEY_SIGN_NEEDSAVE)
